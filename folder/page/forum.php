...
<aside class="s-12 m-12 l-12 xl-12 aside-nav minimize-on-small outerdiv" >
                       ...
                       <div class="innerdiv">
                        ...
                        <div>
                          ...
                          ?>
                       <p class="questionshow"><a href="question/<?php echo $row['unique_number'];?>/<?php echo $slug;?>" style="color:#444;word-break:all;overflow:hidden; display: flex;flex-wrap: wrap;justify-content: space-between"><?php echo $row['question'];?></a></p>
