...
<html lang="en-US">
   ...
   <?php
                       ...
                       $query="SELECT questionid FROM ask_question WHERE unique_number=:unique_number";
                       $pdo_statment=$con->prepare($query);
                       $pdo_statment->execute(array(":unique_number"=>$_GET["unique_number"]));
                       $questionid=$pdo_statment->fetchColumn();
                      

                       $query="DELETE FROM notification_forum WHERE userid=:user_id AND questionid=:questionid";
                       $pdo_statment=$con->prepare($query);
                       $pdo_statment->execute(array(":user_id"=>$_SESSION["user_id"],":questionid"=>$questionid));
